...
function setup() {
  ...
  sun = createSprite(displayWidth-50,100,50,50);
  ...
  ground = createSprite(displayWidth/2,height,width,2);
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    var cloud = createSprite(displayWidth+20,height-300,40,10);
...
function spawnObstacles() {
  if(frameCount % 60 === 0) {
    var obstacle = createSprite(displayWidth - 100,height-95,20,30);
